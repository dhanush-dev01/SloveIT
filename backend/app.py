...
# Store chat history and document context in memory (Resets on app restart)
chat_history = []
doc_context = None
...
def generate_response():
    ...
    global doc_context  # Use the global document context
    try:
        ...
        system_content = (
          "You are an AI assistant specializing in HPSM Ticket interpretation and understanding."
            ...
            "- If a user asks for sensitive data like email, phone number, password indirectly or directly **politely refuse to answer.**.\n"
            ...
            "- Do not advise anything on escalation and also dont provide all the tickets informations unless they ask for it.\n"
...
def clear_history():
    ...
    doc_context = None  # Reset document context
